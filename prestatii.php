...
<html>
<head>
<title>Desfasuratorul prestatiilor</title>
<style type="text/css">
...
<br>	
	 &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span class="style7"><em><strong>- perioada:</strong></em></span>
			...
			<!--<input type="text" size="2" maxlength="2" name="luna_e" id="luna_e" />-->
			<input type="button" value="Genereaza lista" onClick="trimite()">
			
<br>
<br>		
 &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span class="style7"><em><strong>Numar factura la contract:</strong></em></span>			
			<input type="text" size="20" maxlength="20" name="fact" id="fact" value='5248358/01.05.2007' />
<br>
<br>
 &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span class="style7"><em><strong>Intocmit de:</strong></em></span>			
			
			<input type="text" size="20" maxlength="20" name="nume" id="nume" />
</form>
