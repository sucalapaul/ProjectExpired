...
if ($_SESSION['user']==1){
	...
	if ($indice!=0){
		...
		if ($rqt) {
			...
			$d9= strtotime($exp_rovi);
			$exp_rovi = date("d/m/Y",$d9);
			$d10=strtotime($exp_traseu);
			$exp_traseu = date("d/m/Y",$d10);

			if ($d1<944000000){$exp_itp="neprecizat";};
			if ($d2<944000000){$exp_tah="neprecizat";};
			if ($d3<944000000){$exp_cls="neprecizat";};
			...
			if ($d9<944000000){$exp_rovi="neprecizat";};
			if ($d10<944000000){$exp_traseu="neprecizat";};

			if ($d1>2100000000){$exp_itp="nu are";};
			if ($d2>2100000000){$exp_tah="nu are";};
			if ($d3>2100000000){$exp_cls="nu are";};
			...
			if ($d9>2100000000){$exp_rovi="nu are";};
			if ($d10>2100000000){$exp_traseu="nu are";};
			
			
			if ($seria_casco==""){$seria_casco="neprecizat";};
			if ($societatea==""){$societatea="neprecizat";};
			if ($den_traseu==""){$den_traseu="neprecizat";};
		}
	...
	if(isset($_POST["OPERATIE"]) && $_POST["OPERATIE"]=="AD")
	{
		...
		$exp_cls1=$_POST['an_cls'].'-'.$_POST['luna_cls'].'-'.$_POST['zi_cls'];
		...
		$exp_traseu1=$_POST['an_traseu'].'-'.$_POST['luna_traseu'].'-'.$_POST['zi_traseu'];
		
		$seria_casco=$_POST['seria_casco'];
		$societatea=$_POST['societatea'];
		$den_traseu=$_POST['den_traseu'];
		/*	$clasi=$_POST['clasi'];*/

		if ($exp_itp1=="--"){$exp_itp1="2036-7-22";};
		if ($exp_tah1=="--"){$exp_tah1="2036-7-22";};
		if ($exp_cls1=="--"){$exp_cls1="2036-7-22";};
		...
		if ($exp_traseu1=="--"){$exp_traseu1="2036-7-22";};
		...
		$query="INSERT INTO revizii (id_masina, exp_itp, exp_tah, exp_cls, exp_rca, exp_cas, exp_lic, exp_itpi, seria_casco, societatea, leasing, exp_rovi, exp_traseu, den_traseu) VALUES ('$indice', '$exp_itp1', '$exp_tah1', '$exp_cls1', '$exp_rca1', '$exp_cas1', '$exp_lic1', '$exp_itpi1', '$seria_casco', '$societatea', '$leasing1', '$exp_rovi1', '$exp_traseu1', '$den_traseu')";
...
<input type="hidden" id="exp_cls_vechi" name="exp_cls_vechi" value="">
...
<input type="hidden" id="exp_traseu_vechi" name="exp_traseu_vechi" value="">
...
<input type="hidden" id="den_traseu_vechi" name="den_traseu_vechi" value="">
...
<tr><td align="left" height="35">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <strong>Data expirarii clasificare :</strong>
<input type="hidden" size="2" maxlength="2" name="zi_cls" id="zi_cls" value="<?php echo date("d" ,$d3); ?>" />
<input type="hidden" size="2" maxlength="2" name="luna_cls" id="luna_cls" value="<?php echo date("m" ,$d3); ?>" />
<input type="hidden" size="4" maxlength="4" name="an_cls" id="an_cls" value="<?php echo date("Y" ,$d3); ?>" />
<!--  <input type="text" size="10" maxlength="10" name="exp_cls" id="exp_cls" disabled value="<?php echo $exp_cls; ?>"/>-->
<input type="text" size="10" maxlength="10" name="exp_cls" id="exp_cls" disabled value="<?php echo $exp_cls; ?>"/>
<a onclick="ShowCal('exp_cls', 'zi_cls', 'luna_cls', 'an_cls', 'calend_cls'); return false;"><img style="border:none" src="images/calendar.gif" /></a><a onclick="nuare('cls')">&nbsp;&nbsp;<img src="images/buton_nu_are.jpg" style="cursor:pointer" /></a>  
...
<tr><td align="left" height="35">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<strong>Data expirarii rovi :</strong>
<input type="hidden" size="2" maxlength="2" name="zi_rovi" id="zi_rovi" value="<?php echo date("d" ,$d9); ?>" />
<input type="hidden" size="2" maxlength="2" name="luna_rovi" id="luna_rovi"  value="<?php echo date("m" ,$d9); ?>" />
<input type="hidden" size="4" maxlength="4" name="an_rovi" id="an_rovi"   value="<?php echo date("Y" ,$d9); ?>" />
...
<tr><td align="left" height="35">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<strong>Data expirarii traseu :</strong>
<input type="hidden" size="2" maxlength="2" name="zi_traseu" id="zi_traseu" value="<?php echo date("d" ,$d10); ?>" />
<input type="hidden" size="2" maxlength="2" name="luna_traseu" id="luna_traseu"  value="<?php echo date("m" ,$d10); ?>" />
<input type="hidden" size="4" maxlength="4" name="an_traseu" id="an_traseu"   value="<?php echo date("Y" ,$d10); ?>" />
<input type="text" size="10" maxlength="10" name="exp_traseu" id="exp_traseu" disabled value="<?php echo $exp_traseu; ?>"/>
<!--<input type="text" size="10" maxlength="10" name="exp_itp" id="exp_itp" disabled /> -->
<a onclick="ShowCal('exp_traseu', 'zi_traseu', 'luna_traseu', 'an_traseu', 'calend_traseu'); return false;"><img style="border:none" src="images/calendar.gif" /></a><a onclick="nuare('traseu')">&nbsp;&nbsp;<img src="images/buton_nu_are.jpg" style="cursor:pointer" /></a>
</td></tr>	


<tr><td align="left" height="35">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<strong>Denumire traseu :</strong>
<input type="text" size="10" maxlength="10" name="den_traseu" id="den_traseu"  value="<?php echo $den_traseu; ?>"/>
</td></tr>	
...
if ($_SESSION['user']==1){
	...
	echo "<tr><td>Nr.inmatric.</td><td>Data exp. ITP</td><td>Data exp. tahograf</td><td>Data exp. clasificare</td><td>Data exp. RCA</td><td>Data exp. casco</td><td>Data exp. licenta</td><td>Data exp. ITPI</td><td>Seria casco</td><td>Societatea de asigurari</td><td>Durata contr. leasing</td></tr>";
	require "dataazi.php";
	$expira=0;
	$i=1;
	...
	echo "<br><br>";
	echo '<table border=1 cellpadding="1" cellspacing="0">';
	echo "<tr><td>Data exp. Rovi</td><td>Data exp. lic. traseu</td><td>Denumire traseu</td></tr>";
	echo '<tr bgcolor="#cfe4e9" >';
	
	echo '<td id="field_10_'.$i.'" align="center" value="'.$exp_rovi.'" >';
	...
	echo '<td id="field_11_'.$i.'" align="center" value="'.$exp_traseu.'" >';
	...
	echo '<td id="field_12_'.$i.'" align="left" ';
	echo ' value="'.$den_traseu.'" >'.$den_traseu.'</td>';
...
style="position:absolute;  top:12%; left:57%; width:184px; height:169px; border:none;display:none;z-index:0"  ></iframe>
<div ID="calend_itp" style="display:none; position:absolute; top:12%; left:57% ;z-index:100"></div>
<iframe scrolling="no" frameborder="0" id="calend_tah1"

style="position:absolute;  top:17%; left:57%; width:184px; height:169px; border:none;display:none;z-index:0"  ></iframe>
<div ID="calend_tah" style="display:none; position:absolute; top:17%; left:57% ;z-index:100"></div>

<iframe scrolling="no" frameborder="0" id="calend_cls1"
style="position:absolute;  top:22%; left:57%; width:184px; height:169px; border:none;display:none;z-index:0"  ></iframe>
<div ID="calend_cls" style="display:none; position:absolute; top:22%; left:57% ;z-index:100"></div>

<iframe scrolling="no" frameborder="0" id="calend_rca1"
style="position:absolute;  top:25%; left:57%; width:184px; height:169px; border:none;display:none;z-index:0"  ></iframe>
<div ID="calend_rca" style="display:none; position:absolute; top:25%; left:57% ;z-index:100"></div>

<iframe scrolling="no" frameborder="0" id="calend_cas1"
style="position:absolute;  top:40%; left:57%; width:184px; height:169px; border:none;display:none;z-index:0"  ></iframe>
<div ID="calend_cas" style="display:none; position:absolute; top:40%; left:57% ;z-index:100"></div>

<iframe scrolling="no" frameborder="0" id="calend_lic1"
style="position:absolute;  top:45%; left:57%; width:184px; height:169px; border:none;display:none;z-index:0"  ></iframe>
<div ID="calend_lic" style="display:none; position:absolute; top:45%; left:57% ;z-index:100"></div>

<iframe scrolling="no" frameborder="0" id="calend_itpi1"
style="position:absolute;  top:50%; left:57%; width:184px; height:169px; border:none;display:none;z-index:0"  ></iframe>
<div ID="calend_itpi" style="display:none; position:absolute; top:50%; left:57% ;z-index:100"></div>

<iframe scrolling="no" frameborder="0" id="calend_rovi1"
style="position:absolute;  top:65%; left:57%; width:184px; height:169px; border:none;display:none;z-index:0"  ></iframe>
<div ID="calend_rovi" style="display:none; position:absolute; top:65%; left:57% ;z-index:100"></div>

<iframe scrolling="no" frameborder="0" id="calend_traseu1"
style="position:absolute;  top:70%; left:57%; width:184px; height:169px; border:none;display:none;z-index:0"  ></iframe>
<div ID="calend_traseu" style="display:none; position:absolute; top:70%; left:57% ;z-index:100"></div>

<iframe scrolling="no" frameborder="0" id="calend_leasing1"
style="position:absolute;  top:60%; left:57%; width:184px; height:169px; border:none;display:none;z-index:0"  ></iframe>
<div ID="calend_leasing" style="display:none; position:absolute; top:60%; left:57% ;z-index:100"></div>
</body>
</html>
